...
import { importsDeleteRoutes } from './http/routes/imports-delete.js';
import { importsPdfRoutes } from './http/routes/imports-pdf.js';
...
await app.register(totpRoutes);
  ...
  await app.register(importsPdfRoutes);
