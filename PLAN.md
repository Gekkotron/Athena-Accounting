...
- [ ] Récurrent — Task 2: page shell + Détectés tab (frontend)     <!-- session: interactive -->
...
- [ ] Récurrent — Task 3: À venir tab (upcoming bills)     <!-- session: interactive -->
...
- [ ] Récurrent — Task 4: Prévision tab + Dashboard forecast overlay     <!-- session: interactive -->
