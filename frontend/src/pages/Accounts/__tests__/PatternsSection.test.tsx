...
// PatternsSection uses the 'accounts' namespace. Preload it for both
// locales, pinned to French, so `useTranslation` never suspends and the
// existing French-literal assertions below keep matching real rendered
// text.
pinLocale('accounts');
