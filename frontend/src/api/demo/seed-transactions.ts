...
import { MONTH_DAYS, ymd, fmt, normalize } from './seed-utils';

export const SEED_TODAY = '2026-07-18';
...
export function buildCheckpoints(txs: Transaction[]): BalanceCheckpoint[] {
...
export function buildRecurringSeries(transactions: Transaction[]): RecurringSeries[] {
